    ...
    <div>
      ...
      {long ? (
        <button
          ...
          className="text-accent-500 text-[11px] hover:underline"
        >
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <span className="text-ink font-mono text-xs font-semibold">{call.toolName}</span>
        {result ? (
      ...
      {result ? (
        <div className="border-edge mt-1.5 border-t pt-1.5">
          {result.isError ? (
